    ...
    <div class="form-container">
        ...
        <form @submit.prevent="submitForm" class="form">
            <div v-for="(slot, index) in timeSlots" :key="index" class="time-slot-form">
                ...
                <button type="button" @click="removeTimeSlot(index)" class="btn btn-danger">Видалити цей
                    таймслот</button>
            </div>
            <div class="form-buttons">
                <button type="button" @click="addTimeSlot" class="btn btn-primary btn-left">Додати ще один
                    таймслот</button>
